...
1. Patching the game
Apply "Delta Emerald v1.1.5.ups" patch to your "1986 - Pokemon Emerald (U)(TrashMan).gba" rom.
...
2. Changelog
Version 1.1.5
-Some Gen 6 moves are renamed to more resemble their official names (e.g. Charming Cry -> Disarm Voice) 
-Protector doesn't freeze the game anymore
-Sudowoodo's ability to breed is fixed
-Wartortle can now evolve into Blastoise
Version 1.1.4
...
--New Eeveelutions produce same species instead of an Eevee (e.g. Leafeon produces another Leafeon, not an Eevee)
--New baby Pokémon take extremely long time to hatch (e.g. Chingling, Mime Jr.)
--Some Pokémon Eggs freeze the game when you try to take them from the Day-Care Man (e.g. Heracross, Pinsir)
