...
;Function92bbe:
; ;This function merely divides by four, in the usual Game Freak style of doing this.
; ;Thankfully it's completely unreferenced, but I'm leaving it here as a way of cheering up bad devs — there's always someone worse.
;	push hl
;	srl a
;	srl a
;	add LOW(.numbers)
