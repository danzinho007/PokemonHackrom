...
DusknoirBackPic:     INCBIN "gfx/pics/dusknoir/back.2bpp.lz"
...
DusknoirFrontPic:    INCBIN "gfx/pics/dusknoir/front.2bpp.lz"
...
SECTION "Pics small 2", ROMX

GruntmPic:           INCBIN "gfx/trainers/grunt_m.2bpp.lz"

SECTION "Pics small 3", ROMX
