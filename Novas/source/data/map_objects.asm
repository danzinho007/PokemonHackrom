...
SpriteMovementData::
	...
	sprite_movement_data SPRITEMOVEFN_BOUNCE,                DOWN,   PERSON_ACTION_BOUNCE,       $22,    $00,    %0000 ; 16
	...
	sprite_movement_data SPRITEMOVEFN_SNOW,                  DOWN,   PERSON_ACTION_SNOW,         $8e,    $02,    %0000 ; 25
	sprite_movement_data SPRITEMOVEFN_00,                    DOWN,   PERSON_ACTION_STAND,        $00,    $00,    %0000 ; 26
	sprite_movement_data SPRITEMOVEFN_ALTERNATE,             DOWN,   PERSON_ACTION_ALTERNATE,    $2e,    $00,    %0000 ; 27
