...
hBankswitchLoadRoutine      EQU $ff88
...
hDivisor                    EQU $ffb7 ; 1 byte long (or 2 for DivideLong)
hQuotient                   EQU $ffb4 ; result (3 bytes long)
hRemainder                  EQU $ffb7 ; 1 byte long after Divide, 2 bytes long after Divide16/DivideLong
...
; all used in vblank
hCrashSavedHL               EQU $fff9
hCrashSavedErrorCode        EQU $fff9

hCrashSP                    EQU $fffb

hCrashSavedA                EQU $fffd
hPalTrick                   EQU $fffe
HRAM_END                    EQU $ffff
