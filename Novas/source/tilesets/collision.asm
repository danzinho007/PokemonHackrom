SECTION "Tile collision table", ROMX, ALIGN[8]
NONTALKABLE EQUS "db"
...
TileCollisionTable::
	...
	NONTALKABLE  LANDTILE ; COLL_SNOW
	...
	NONTALKABLE  LANDTILE ; COLL_SUPER_TALL_GRASS
	...
	NONTALKABLE  LANDTILE ; COLL_CURRENT_STOP
	NONTALKABLE  LANDTILE ; COLL_CURRENT_RIGHT
	NONTALKABLE  LANDTILE ; COLL_CURRENT_LEFT
	NONTALKABLE  LANDTILE ; COLL_CURRENT_UP
	NONTALKABLE  LANDTILE ; COLL_CURRENT_DOWN
