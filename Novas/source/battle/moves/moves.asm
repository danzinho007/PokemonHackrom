...
ENDM
	...
	move GROWTH,        EFFECT_GROWTH,              0, NORMAL,   STATUS,    100,    20,     0 ;import from AC
	...
	move WILL_O_WISP,   EFFECT_WILL_O_WISP,         0, FIRE,     STATUS,     85,    15,     0
	move SOFTBOILED,    EFFECT_HEAL,                0, NORMAL,   STATUS,    100,    10,     0
	move HI_JUMP_KICK,  EFFECT_JUMP_KICK,         130, FIGHTING, PHYSICAL,   90,    10,     0
	move MUSTARD_GAS,   EFFECT_BURN_HIT,           90, GAS,      PHYSICAL,  100,    10,    30 ;new
	...
	move NERVE_GAS,     EFFECT_PARALYZE_HIT,      110, GAS,      PHYSICAL,   70,    10,    30 ;new
	...
	move METEOR_MASH,   EFFECT_METEOR_MASH,        90, STEEL,    PHYSICAL,   90,    10,    20 ;RIP infinite Mashing
	move VOID_SPHERE,   EFFECT_NORMAL_HIT,         85, NORMAL,   SPECIAL,   100,    15,     0
	...
	move CHARM,         EFFECT_ATTACK_DOWN_2,       0, FAIRY_T,  STATUS,    100,    20,     0
	...
	move HIDDEN_POWER,  EFFECT_HIDDEN_POWER,       70, CURSE_T,  SPECIAL,   100,    15,     0
	...
	move GHOST_HAMMER,  EFFECT_NORMAL_HIT,         85, GHOST,    PHYSICAL,  100,    15,     0 ;new
