	...
	const BATTLEANIMSTRUCT_FLAGS
	const BATTLEANIMSTRUCT_YFIX
...
BATTLEANIMSTRUCT_LENGTH EQU const_value
	...
	const ANIM_OBJ_METALLURGY_ROCKS
	...
	const ANIM_OBJ_GAS_YELLOW
	const ANIM_OBJ_GAS_GREEN
	const ANIM_OBJ_GAS_BLUE
	const ANIM_OBJ_MOON
	const ANIM_OBJ_LAVA_POOL
	const ANIM_OBJ_BUBBLING_LAVA
	const ANIM_OBJ_ENERGY_BALL
	const ANIM_OBJ_HAIL
	const ANIM_OBJ_CRYSTAL_BOLT_1
	const ANIM_OBJ_CRYSTAL_BOLT_2
	const ANIM_OBJ_CRYSTAL_BOLT_3
	const ANIM_OBJ_BUBBLING_WATER
	const ANIM_OBJ_GAS_RED
	const ANIM_OBJ_GHOST_FIRE_ORBIT
	const ANIM_OBJ_GEM
	const ANIM_OBJ_SIGNAL_BEAM
	const ANIM_OBJ_SPRING_BUD

	const_def
	const BATTLEANIMFUNC_NULL
	const BATTLEANIMFUNC_MOVE_FROM_PLAYER_TO_ENEMY_BY_PARAM
	const BATTLEANIMFUNC_MOVE_FROM_PLAYER_TO_ENEMY_BY_PARAM_AND_DISAPPEAR
	const BATTLEANIMFUNC_03
	const BATTLEANIMFUNC_ARC_FROM_PLAYER_TO_ENEMY_AND_DISAPPEAR
	const BATTLEANIMFUNC_THROW_FROM_PLAYER_TO_ENEMY
	const BATTLEANIMFUNC_THROW_FROM_PLAYER_TO_ENEMY_AND_DISAPPEAR
	...
	const BATTLEANIMFUNC_RAISE_BY_PARAM
...
const_value SET 1
	...
	const ANIM_BG_35
	const ANIM_BG_SLIDE_IN_MON
	const ANIM_BG_SLIDE_OUT_MON
