...
const_value SET 1
	...
	const TILESET_FIRELIGHT_CAVERNS ;21
...
const_value SET $80
	const PAL_BG_PRIORITY_GRAY
	const PAL_BG_PRIORITY_RED
	const PAL_BG_PRIORITY_GREEN
	const PAL_BG_PRIORITY_WATER
	const PAL_BG_PRIORITY_YELLOW
	const PAL_BG_PRIORITY_BROWN
	const PAL_BG_PRIORITY_ROOF
	const PAL_BG_PRIORITY_TEXT
