...
.Jumptable
	dw PartyMenu_InitAnimatedMonIcon
	dw NamingScreen_InitAnimatedMonIcon
	dw MoveList_InitAnimatedMonIcon
	dw Trade_LoadMonIconGFX
	dw Mobile_InitAnimatedMonIcon
	dw GenericDummyFunction ;dummied out
...
Mobile_InitAnimatedMonIcon:
	...
	xor a
	ld [hli], a
	inc hl ; point to SPRITEANIMSTRUCT_XCOORD
	ld a, 9 * 8
	ld [hli], a
	ld [hl], a
	ret
...
; type is partymon icon
	xor a ;ld a, SPRITE_ANIM_INDEX_PARTY_MON
