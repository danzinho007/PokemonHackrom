...
; Decompress Tyranitar gfx
	ld hl, TitleTyranitarGFX
...
; lines 3-4
	hlbgcoord 0, 2, vBGAttrs
	ld bc, 3 bgrows
	ld a, 2
	call ByteFill
; line 5
	hlbgcoord 0, 5, vBGAttrs
	ld bc, 1 bgrows
	ld a, 3
	call ByteFill
; line 6
	hlbgcoord 0, 6, vBGAttrs
	ld bc, 1 bgrows
	ld a, 4
	call ByteFill
; line 7
	hlbgcoord 0, 7, vBGAttrs
	ld bc, 1 bgrows
	ld a, 5
	call ByteFill
; lines 8-9
	hlbgcoord 0, 8, vBGAttrs
	ld bc, 4 bgrows
	ld a, 6
	call ByteFill

; 'PRISM VERSION'
	hlbgcoord 5, 9, vBGAttrs
	ld bc, NAME_LENGTH ; length of version text
	ld a, 1
	call ByteFill

; Pokemon gfx
	hlbgcoord 0, 12, vBGAttrs
	ld bc, 7 bgrows ; the rest of the screen
	ld a, 8
	call ByteFill

; Trainers gfx
	hlbgcoord 11, 12, vBGAttrs
	lb bc, 7, 8
	ld a, 15
.row
	push bc
...
TitleTyranitarGFX: INCBIN "gfx/title/tyranitar.w136.2bpp.lz"
TitleLogoGFX: INCBIN "gfx/title/logo.w160.t6.2bpp.lz"
